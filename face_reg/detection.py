...
class recognition:
    ...
    def __init__(self):
        self.infer_model, self.mtcnn = self.create_facenet_models()
        self.bounding_boxes = []
        self.landmarks = []
    ...
    def face_recognition(self, input_paths, input_names, anchor_paths, anchor_labels, finding_name):
        ...
        if input_paths:
            ...
            anchor_embed = vector_embedding(self.infer_model, cropped_img_anchor, 'anchor')
            input_embed = vector_embedding(self.infer_model, cropped_img_input, 'input')
